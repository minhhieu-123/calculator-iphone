...
export const GROUPS_B_BUTTONS = [
    ...
    { id: 36, kind: 'number', action: 'setScreen', value: '8', title: '8', className: 'third' },
    { id: 37, kind: 'number', action: 'setScreen', value: '9', title: '9', className: 'third' },
    { id: 38, kind: 'operator', action: 'setScreen', value: '*', title: 'x', className: 'primary' },

    { id: 39, kind: 'number', action: 'setScreen', value: '4', title: '4', className: 'third' },
    { id: 40, kind: 'number', action: 'setScreen', value: '5', title: '5', className: 'third' },
    { id: 41, kind: 'number', action: 'setScreen', value: '6', title: '6', className: 'third' },
    { id: 42, kind: 'operator', action: 'setScreen', value: '-', title: '-', className: 'primary' },

    { id: 43, kind: 'number', action: 'setScreen', value: '1', title: '1', className: 'third' },
    { id: 44, kind: 'number', action: 'setScreen', value: '2', title: '2', className: 'third' },
    { id: 45, kind: 'number', action: 'setScreen', value: '3', title: '3', className: 'third' },
    { id: 46, kind: 'operator', action: 'setScreen', value: '+', title: '+', className: 'primary' },
